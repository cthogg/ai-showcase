...
const AGENTS: ReadonlyArray<Agent> = [
  {
    ...
    tasks: [
      ...
      { id: "logic_1", name: "Breakout", category: "logic", score: 79 },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "logic_1", name: "Breakout", category: "logic", score: 78 },
...
/** Returns a random number between min and max. */ function randomBetween(
  min: number,
  max: number
): number {
...
/** Returns true a random percentage of invocations. */ function randomCondition(
...
/**  * Returns the data as a Promise, delayed by a random latency and  * occasionally failing with an error.  * */ function asFallibleAsyncResponse<
  T
>(data: T): Promise<T> {
